"""
Django settings for epoc_48427 project.
...
WSGI_APPLICATION = 'epoc_48427.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "epoc Support <support@epoc-48427.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "epoc_48427 API",
    "DESCRIPTION": "API documentation for epoc_48427 App",
    "VERSION": "v1",
}
